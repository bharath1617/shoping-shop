...
let range50 = false;
let range100 = false;
let range100plus = false;
function setRange(res) {
  if (res == "0-25") range25 = !range25;
  else if (res == "25-50") range50 = !range50;
  else if (res == "50-100") range100 = !range100;
  else if (res == "100on") range100plus = !range100plus;
  return filterCategory();
}
...
function filterRange(filteredByText) {
  if (!range25 && !range50 && !range100 && !range100plus) 

  return populateProductScreen(filteredByText);
      ...
      <div class="one">
        <div class="container" style="border: 1px solid grey; overflow:hidden;">
          ...
          <div class="title">
            ...
            <div class="px-3 pb-3">Rating: ${Math.floor(element.rating.rate)} out of 5</div>
